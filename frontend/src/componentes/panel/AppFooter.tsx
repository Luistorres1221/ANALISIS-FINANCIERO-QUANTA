    ...
    <footer className="mt-16 border-t border-border bg-background/60 backdrop-blur">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="pt-5 flex flex-wrap items-center justify-between gap-3 text-[11px] font-mono text-muted-foreground/60">
          <span>
            © {AÑO === 2026 ? "2026" : `2026–${AÑO}`} <span className="text-muted-foreground">QUANTA LTDA</span> · Todos los derechos reservados.
          </span>
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            <span>Desarrollado por <span className="text-muted-foreground">Luis Torres</span></span>
